 ...
 * @final
 */
class FileHandler_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'FileHandler\\Modules\\FileAsset\\Controller\\FileController' => 'getFileControllerService',
    ...
    /**
     * Gets the public 'FileHandler\Modules\FileAsset\Controller\FileController' shared autowired service.
     *
     * @return \FileHandler\Modules\FileAsset\Controller\FileController
     */
    protected function getFileControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Modules/FileAsset/Controller/FileController.php';

        $this->services['FileHandler\\Modules\\FileAsset\\Controller\\FileController'] = $instance = new \FileHandler\Modules\FileAsset\Controller\FileController();
        ...
        $instance->setContainer((new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'router' => '?',
            'session' => '?',
        ]))->withContext('FileHandler\\Modules\\FileAsset\\Controller\\FileController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dbYeqI4QLz', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getCache_SystemService()
    {
        ...
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sZcCPIRR6I', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        }, 1), true, ($this->targetDir.''.'/FileHandler_KernelDevDebugContainerDeprecations.log'));
    }
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/FileHandler_KernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'FileHandler_KernelDevDebugContainer',
